...
GET https://api.fanvue.com/tracking-links

List authenticated user's tracking links with cursor-based pagination.

<Info>Scope required: `read:tracking_links`</Info>

Reference: https://api.fanvue.com/docs/api-reference/reference/tracking-links/list-tracking-links
...
info:
  ...
  version: endpoint_.listTrackingLinks
paths:
  /tracking-links:
    get:
      ...
      responses:
        '200':
          ...
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/listTrackingLinks_Response_200'
        '400':
...
components:
  schemas:
    TrackingLinksGetResponsesContentApplicationJsonSchemaDataItemsExternalSocialPlatform:
      type: string
      enum:
        - value: facebook
        - value: instagram
        ...
        - value: twitter
        - value: youtube
    TrackingLinksGetResponsesContentApplicationJsonSchemaDataItems:
      type: object
      properties:
        uuid:
          type: string
        ...
        externalSocialPlatform:
          $ref: >-
            #/components/schemas/TrackingLinksGetResponsesContentApplicationJsonSchemaDataItemsExternalSocialPlatform
      ...
      required:
        ...
        - createdAt
        - clicks
    listTrackingLinks_Response_200:
      type: object
      properties:
        data:
          type: array
          items:
            $ref: >-
              #/components/schemas/TrackingLinksGetResponsesContentApplicationJsonSchemaDataItems
        nextCursor:
          type:
            - string
            - 'null'
...
```java
HttpResponse<String> response = Unirest.get("https://api.fanvue.com/tracking-links")
...
$response = $client->request('GET', 'https://api.fanvue.com/tracking-links', [
  'headers' => [
    'Authorization' => 'Bearer <token>',
    'X-Fanvue-API-Version' => '2025-06-26',
  ],
