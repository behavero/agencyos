...
Reference: https://api.fanvue.com/docs/api-reference/reference/posts/create-post
      ...
      responses:
        '201':
          ...
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/createPost_Response_201'
        '400':
...
```java
HttpResponse<String> response = Unirest.post("https://api.fanvue.com/posts")
...
$response = $client->request('POST', 'https://api.fanvue.com/posts', [
  'body' => '{
  "audience": "subscribers"
}',
  'headers' => [
