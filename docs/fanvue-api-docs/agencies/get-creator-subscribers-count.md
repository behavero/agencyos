...
GET https://api.fanvue.com/creators/{creatorUserUuid}/insights/subscribers

Returns cursor-paginated subscribers count for the specified creator over a specified time period.
...
Reference: https://api.fanvue.com/docs/api-reference/reference/agencies/get-creator-subscribers
...
openapi: 3.1.1
info:
  title: Get subscribers count for a creator
  version: endpoint_.getCreatorSubscribers
paths:
  /creators/{creatorUserUuid}/insights/subscribers:
    get:
      operationId: get-creator-subscribers
      summary: Get subscribers count for a creator
      description: >-
        Returns cursor-paginated subscribers count for the specified creator
      ...
      responses:
        '200':
          ...
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/getCreatorSubscribers_Response_200'
        '400':
          description: >-
...
components:
  schemas:
    CreatorsCreatorUserUuidInsightsSubscribersGetResponsesContentApplicationJsonSchemaDataItems:
      type: object
      properties:
        date:
          type: string
      ...
      required:
        ...
        - newSubscribersCount
        - cancelledSubscribersCount
    getCreatorSubscribers_Response_200:
      type: object
      properties:
        data:
          type: array
          items:
            $ref: >-
              #/components/schemas/CreatorsCreatorUserUuidInsightsSubscribersGetResponsesContentApplicationJsonSchemaDataItems
        nextCursor:
          type:
            - string
            - 'null'
...
url = "https://api.fanvue.com/creators/creatorUserUuid/insights/subscribers"
...
```javascript
const url = 'https://api.fanvue.com/creators/creatorUserUuid/insights/subscribers'
const options = {
  method: 'GET',
...
url = URI("https://api.fanvue.com/creators/creatorUserUuid/insights/subscribers")
...
```java
HttpResponse<String> response = Unirest.get("https://api.fanvue.com/creators/creatorUserUuid/insights/subscribers")
...
$response = $client->request('GET', 'https://api.fanvue.com/creators/creatorUserUuid/insights/subscribers', [
  'headers' => [
    'Authorization' => 'Bearer <token>',
    'X-Fanvue-API-Version' => '2025-06-26',
  ],
...
```csharp
var client = new RestClient("https://api.fanvue.com/creators/creatorUserUuid/insights/subscribers");
...
let request = NSMutableURLRequest(url: NSURL(string: "https://api.fanvue.com/creators/creatorUserUuid/insights/subscribers")! as URL,
