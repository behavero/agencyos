...
export async function GET(
  ...
  try {
    ...
    const paycheck = {
      ...
      commission_percent: payout.sales_generated > 0 ? (payout.commission_pay / payout.sales_generated) : 0,
    ...
    const pdfStream = await renderToStream(
      StatementPDF({ paycheck, period, runId: params.runId })
    )
